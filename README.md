...
- To execute the Application locally:
  ...
  - You should now see the extension loaded in the Chrome toolbar. Navigate to any YouTube video, click on the extension icon ![Alt text](./extention-icon.svg), and click "Summarize" to see the summary of the video   transcript.
  - All Done..!!
