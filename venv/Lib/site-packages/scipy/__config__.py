...
CONFIG = _cleanup(
    {
        "Compilers": {
            ...
            "pythran": {
                "version": "0.12.1",
                "include directory": r"C:\Users\runneradmin\AppData\Local\Temp\pip-build-env-yajwq4a4\overlay\Lib\site-packages\pythran"
            },
        },
        "Machine Information": {
            "host": {
        ...
        "Python Information": {
            "path": r"C:\Users\runneradmin\AppData\Local\Temp\cibw-run-5o1gjg1j\cp38-win_amd64\build\venv\Scripts\python.exe",
            "version": "3.8",
        },
    }
)
